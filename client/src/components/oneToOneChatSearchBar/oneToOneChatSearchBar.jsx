...
import "./oneToOneChatSearchBar.scss";
...
import OneToOneChatSearchReply from "./oneToOneChatSearchReply";
...
function OneToOneChatSearchBar() {
  ...
  return (
    <div style={{ position: "relative" }}>
      {/* {useSelector((state)=>state.replytoggle.clicked)&&<OneToOneChatSearchReply/>} */}
      <div className="chatsearchbar">
        ...
        <div className="chatsearchbar__input">
          <form onSubmit={handleSubmit}>
            <input
              ...
              className="chatsearchbar__input-text"
              type="text"
            />
        ...
        <div className="chatsearchbar__gificon">
          <IconButton className={classes.button} aria-label="settings">
      ...
      {useSelector((state) => state.open.open) && (
...
export default OneToOneChatSearchBar;
