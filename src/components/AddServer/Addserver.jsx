...
function Addserver() {
  ...
  const handleSubmit = async (e) => {
        ...
        await serverRef
          ...
          .then(async (value) => {
            ...
            await rolerefid
              ...
              .then(async () => {
                const serverroleRef = serverRef
                  .doc(value.id)
                  .collection("allroles");
                const roletyperef = roleRef
                  .doc(value.id)
                  .collection("rolemenu");
                await serverroleRef
                  .add({
                  ...
                  .then(async (myval) => {
                    ...
                    const serverallroles = serverroleRef
                      .doc(myval.id)
                      .collection("allroles");
                    serverallroles
                      .add({
    ...
    setformValue("");
    if (serverid && generalid)
      history.push(`/discord-clone/channels/${serverid}/${generalid}`);
  };
      ...
      >
        <DialogContent className={classes.dialogcontent}>
          <DialogContentText component="div" className={classes.header}>
            ...
            <Typography
              component={"span"}
              className={classes.header__servername}
            >
              SERVER NAME
            </Typography>
          </DialogContentText>
        ...
        <DialogActions className={classes.dialogaction}>
          <button
            type="text"
            onClick={handleClose}
            className="addserver__form-back"
          >
            Back
          </button>
          <form onSubmit={handleSubmit} className="addserver__form">
            <button
              type="submit"
              onClick={handleClose}
              className="addserver__form-button"
            >
              Create
            </button>
          </form>
