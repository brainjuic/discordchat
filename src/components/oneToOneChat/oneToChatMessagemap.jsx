                    ...
                    <div className="chatmessage__content">
                        ...
                        <div className="chatmessage__message">
                         ...
                         <Linkify componentDecorator={componentDecorator}>
                            {msg && !!msg.message ? message : !msg.base64 && <OneToChatMessageRenderAudio msg={msg}/>}
                            </Linkify>   
                         }
                            {msg.base64 &&<img src={msg.base64} alt="cannot decode"/>}
                            {linkifiedmsg && linkifiedmsg.length>1?linkifiedmsg.map((link)=><OneToChatMessageRenderVideo key={link} msg={link}/>):<OneToChatMessageRenderVideo msg={linkifiedmsg}/>}
                        </div>
                    </div>
                </div>
            </div>
...
export default OneToChatMessagemap
